...
export const installationSteps = [
  {
    ...
    content: <div>
      ...
      <ul>
        <li><strong>Micro-frontend</strong> <a
          href="http://ragu-react-server-adapter.herokuapp.com/components/installation"
          target="_blank">http://ragu-react-server-adapter.herokuapp.com/components/installation</a>.
        </li>
        <li><strong>Preview</strong> <a href="http://ragu-react-server-adapter.herokuapp.com/preview/installation"
                                        target="_blank">http://ragu-react-server-adapter.herokuapp.com/preview/installation</a>
        </li>
        <li><strong>Repository</strong> <a
          href="https://github.com/ragu-framework/ragu-react-server-adapter/tree/main/docs-mfe"
          target="_blank">https://github.com/ragu-framework/ragu-react-server-adapter/tree/main/docs-mfe</a></li>
      </ul>
  ...
  },
  {
    ...
    content: <div>
      <p>
        You need to add <strong>ragu-server</strong> and <strong>ragu-react-server-adapter</strong> as dependency of
        you react app.
      </p>

      <p>
        <strong>ragu-server</strong> will expose your front-end as reusable widgets and
        the <strong>ragu-react-server-adapter</strong> has a set of helpers to make the integration between
        ragu-server
    ...
    namePrefix: 'my_project_name_'
      ...
      <p>
        ...
        All configurations described <a target="_blank"
                                        href="https://ragu-framework.github.io/ragu/interfaces/_src_config_.raguserverbaseconfig.html">here</a>
      </p>
    </div>
  },
  {
    ...
    content: <div>
      <p>
        ...
        It means that any file into the <strong>ragu-components</strong> directory will be exposed as
        micro-frontend.
      </p>
      ...
      <ul>
        <li>
          <strong>Component route</strong>:
          http://you-ragu-server-host/components/ragu-components/hello-world/?name=World
        </li>
        <li>
      ...
      <p>There is a problem that is hard to solve when the subject is Server Side Rendering: To know when a
        component finished it renders process.</p>

      <p>To make sure your component is fully render at the server we recommend to does not have async operations on
        component mount. Instead you can define a state function which will load any information your component
        requires it also prevent your component to load twice the same information as Ragu server exposes the state
        to the client.</p>
